...
We have created the base RoR application an a Dockerfile to get you started although we recommend building tis yourself to get familiar with the different steps. If you choose to build it yourself you'll find the instructions below under "Build it yourself".If you want to use this precreated repo you will hav tor use this command:
```
